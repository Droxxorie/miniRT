...
/*   Updated: 2025/12/12 19:07:59 by eraad            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (parse_vec3(line, &obj->data.sphere.center) == EXIT_FAILURE
...
t_status	parse_sphere(t_scene *scene, char **line)
{
	...
	new_obj->data.sphere.radius_squared = new_obj->data.sphere.radius
		* new_obj->data.sphere.radius;
