...
/*   Updated: 2026/01/21 22:52:18 by eraad            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* +#+#+#+#+#+   +#+           */
/* Created: 2026/01/21 22:14:29 by eraad             #+#    #+#             */
/* Updated: 2026/01/21 22:45:10 by eraad            ###   ########.fr       */
/* */
/* ************************************************************************** */

#include <minirt_bonus.h>

static t_color	get_sunset_gradient(t_real y)
{
	t_color	horizon;
	t_color	zenith;
	t_color	ground;
...
static t_color	procedural_sky(t_ray *ray)
{
	t_vec3	dir;
	t_color	bg_color;

	dir = vec3_normalize(ray->direction);
	bg_color = get_sunset_gradient(dir.y);
