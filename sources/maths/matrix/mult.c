...
/*   Updated: 2025/12/15 14:21:12 by eraad            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3	mat4_mult_point(t_mat4 mat, t_point3 point)
{
	...
	result.x = mat.m[0][0] * point.x + mat.m[0][1] * point.y
		+ mat.m[0][2] * point.z + mat.m[0][3];
	result.y = mat.m[1][0] * point.x + mat.m[1][1] * point.y
		+ mat.m[1][2] * point.z + mat.m[1][3];
	result.z = mat.m[2][0] * point.x + mat.m[2][1] * point.y
		+ mat.m[2][2] * point.z + mat.m[2][3];
	return (result);
}
